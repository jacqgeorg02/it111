...
//        logic in the car insurance industry -- if you have traffic tickets, DUIs, other violations, you will be paying more for your insurance
...
//        the tota needs to come after the if statement
        ...
        System.out.println("Cathy's adjusted rate: " +adjustedRate1);
        System.out.println("Kendall's total rate: " +total2);
    }
}
