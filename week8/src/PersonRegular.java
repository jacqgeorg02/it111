...
//        violations will be true or false, so they will be booleans
...
//        the above totals were moved below
...
//         logic in the car insurance industry -- if you have traffic violations, DUIs, other violations. You will be paying more for your insurance!
...
//        Will gender and age make a difference???
        ...
        System.out.println("First Person CreditScore: " +firstPersonCreditScore);
        System.out.print("First Person Preliminary Monthly rate: $");
        System.out.printf("%.2f", monthlyRate1);
        System.out.println();
        System.out.print("First Person Total Monthly rate, with adjustments for age and gender: $");
        ...
        System.out.println("Second Person CreditScore: " +secondPersonCreditScore);
        System.out.print("Second Person Preliminary Monthly rate: $");
        System.out.printf("%.2f", monthlyRate2);
        System.out.println();
        System.out.print("Second Person Total Monthly rate, with adjustments for age and gender: $");
