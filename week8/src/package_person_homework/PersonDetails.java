...
//        we will be entering the info for Cathy and Kendall, but we are assigning values to our fields
        ...
        System.out.println("Adjustment for Gender & Age: $" +firstPerson.assumeGender(adjustedRate));
        System.out.println("Adjustment for age of vehicle: $" +firstPerson.assumeAge(adjustedRate2));
        ...
        System.out.println("Adjustment for Gender & Age: $" +secondPerson.assumeGender(adjustedRate));
        System.out.println("Adjustment for age of vehicle: $" +secondPerson.assumeAge(adjustedRate2));
        ...
        System.out.println("Adjustment for Gender & Age: $" +thirdPerson.assumeGender(adjustedRate));
        System.out.println("Adjustment for age of vehicle: $" +thirdPerson.assumeAge(adjustedRate2));
