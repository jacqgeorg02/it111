...
//        wew will be entering the info by assigning values to our fields
        ...
        double total1 = firstPerson.getRate((monthlyRate)) + firstPerson.assumeGender(adjustedRate)+ firstPerson.assumeCarAge(adjustedRate2);
        double total2 = secondPerson.getRate((monthlyRate)) + secondPerson.assumeGender(adjustedRate)+ secondPerson.assumeCarAge(adjustedRate2);
        double total3 = thirdPerson.getRate((monthlyRate)) + thirdPerson.assumeGender(adjustedRate)+ thirdPerson.assumeCarAge(adjustedRate2);
        ...
        System.out.printf("$%.2f", (firstPerson.assumeGender(adjustedRate)));
        System.out.println();

        System.out.print("Vehicle Age Adjustment: " );
        System.out.printf("$%.2f", (firstPerson.assumeCarAge(adjustedRate2)));
        System.out.println();
        ...
        System.out.print("Adjustments: ");
        System.out.printf("$%.2f", (secondPerson.assumeGender(adjustedRate)));
        System.out.println();

        System.out.print("Vehicle Age Adjustment: " );
        System.out.printf("$%.2f", (secondPerson.assumeCarAge(adjustedRate2)));
        System.out.println();
        ...
        thirdPerson.display();
        System.out.print("Preliminary Rate for " +thirdPerson.name+ ": " );
        System.out.printf("$%.2f", (thirdPerson.getRate(monthlyRate)));
        System.out.println();

        System.out.print("Adjustments: ");
        System.out.printf("$%.2f", (thirdPerson.assumeGender(adjustedRate)));
        System.out.println();

        System.out.print("Vehicle Age Adjustment: " );
        System.out.printf("$%.2f", (thirdPerson.assumeCarAge(adjustedRate2)));
        System.out.println();

        System.out.print("Here is " +thirdPerson.name+ "'s total monthly premium: ");
        System.out.printf("$%.2f", total3);
