...
//        wew will be entering the info by assigning values to our fields
        ...
        System.out.println(" dollars");
        System.out.print("Here is " +firstPerson.name+ "'s total monthly premium: ");
        System.out.printf("%.2f", (firstPerson.assumeGender(adjustedRate) + firstPerson.getRate(monthlyRate)+ firstPerson.assumeCarAge(adjustedRate2)));
        System.out.println(" dollars");
        ...
        System.out.println(" dollars");
        System.out.print("Here is " +secondPerson.name+ "'s total monthly premium: ");
        System.out.printf("%.2f", (secondPerson.assumeGender(adjustedRate) + secondPerson.getRate(monthlyRate)+ secondPerson.assumeCarAge(adjustedRate2)));
        System.out.println(" dollars");
        ...
        System.out.println(" dollars");
        System.out.print("Here is " +thirdPerson.name+ "'s total monthly premium: ");
        System.out.printf("%.2f", (thirdPerson.assumeGender(adjustedRate) + thirdPerson.getRate(monthlyRate)+ thirdPerson.assumeCarAge(adjustedRate2)));
        System.out.println(" dollars");
