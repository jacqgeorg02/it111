...
//        }
// when we use or || only one thing needs to be true
...
//        if (age >= 18) {
//            //        statement
//            System.out.println("Yippy and Skippy! You can order an adult beverage!");
//
//    } else    {
//        //         statement
//        System.out.println("We will have a diet coke!");
//    }
////        amusement park roller coaster -- smaller than 4 feet
//        float height = 3.9f;
//
//        if (height < 4) {
